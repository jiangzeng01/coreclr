...
namespace Tracing.Tests.GCEEStartStop
{
    public class ProviderValidation
    {
        ...
        private static Func<EventPipeEventSource, Func<int>> _DoesTraceContainEvents = (source) => 
        {
            ...
            source.Clr.GCHeap += (eventData) => GCHeapEvents +=1; 
            return () => {
                ...
                Console.WriteLine("GCHeapEvents: " + GCHeapEvents);
                return GCRestartEEStartEvents >= 1000 && GCRestartEEStopEvents >= 1000 && GCRestartEEStartEvents == GCRestartEEStopEvents
                && GCHeapEvents >= 1000 ? 100 : -1;
            };
        };
    }
}